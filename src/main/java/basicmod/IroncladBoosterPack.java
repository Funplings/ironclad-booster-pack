...
@SpireInitializer
public class IroncladBoosterPack implements
    ...
    public static void initialize() {
        new IroncladBoosterPack();
    }

    public IroncladBoosterPack() {
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(IroncladBoosterPack.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
